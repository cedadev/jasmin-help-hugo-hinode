...
Note: The following instructions also assume you already have a **JASMIN login account** and the **jasmin-login** service. If you do not, please [follow steps
...
If you have existing access to MASS via MONSooN, or are a member of Met Office staff, please provide your sponsor will the following details:

- Your full name
- Your official email address

Otherwise, please provide your sponsor with the following details:
...
- A list of MASS projects and/or data sets that you need access to. A **dataset** path is required, and your sponsor should help you determine this.
...
When steps one and two are complete, you will be provided with a MASS account to
use on JASMIN. Please see  
